...
| 网关插件 | `/gateway/plugins` | Higress WasmPlugin 安装、官方应用保护、AppGroup 制品更新、独立的全局/规则开关、原生 ingress/domain/service 规则兼容、共享规则拆分、Ingress 删除清理、MicroApp 配置界面和 YAML 预览编辑 |

...
export default {
    ...
    methods: {
        ...
        testImageCache() {
            ...
            k8sproxy.get('/apis/w7panel.w7.com/v1alpha1/namespaces/' + this.namespaceActive + '/microapps?labelSelector=w7.cc/identifie=w7-registrycache', { loading: true }).then(res => {

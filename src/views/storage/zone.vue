                    ...
                    <template #columns>
                        ...
                        <a-table-column title="绑定状态">
                            <template #cell="{ record }">
                                ...
                                <span v-if="record.state=='attached'&&record.isLock=='true'" class="c-blue ml-10 cursor default-btn" @click="detach.volumeName=record.volumeName;detach.force=false;submitDetach();">解锁</span>
                            </template>
                        </a-table-column>

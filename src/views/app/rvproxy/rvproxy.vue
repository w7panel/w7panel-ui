<template>
    <div class="padding-20">
        <route-breadcrumb />
        <div v-if="permission.includes('gateway/rvproxy/add')" class="mb-20">
            ...
            <table class="com-table"><tbody>
                ...
                <tr v-for="(item,index) in list" :key="index">
                    ...
                    <td>
                        ...
                        <span v-if="permission.includes('gateway/rvproxy/edit')" class="ml-16 cursor c-blue" @click="openForm(item)">编辑</span>
                        <a-popconfirm v-if="permission.includes('gateway/rvproxy/delete')" :content="'确认要删除吗'" @ok="toDelete(item)" position="lt" class="popconfirm-delete" type="warning" :ok-button-props="{status:'danger'}">
...
export default {
    ...
    methods: {
        ...
        toDomain(row){
            this.$router.push('/gateway/rvproxy-domain?name='+row.name)
        },
        getData(){
